...
@Controller
@RequestMapping("${openapi.theatreShowtimes.base-path:}")
public class TheatresApiController implements TheatresApi {

    private final NativeWebRequest request;

    @Autowired
    public TheatresApiController(NativeWebRequest request) {
